        ...
        <section class="py-20">
            <div class="flex flex-wrap md:flex-nowrap p-5">
                <div class="flex items-center justify-center p-5 mx-auto w-full lg:w-1/2">
                    <img alt="Menu Link Image" class="object-fill" src='{{ asset('/storage/assets/img/meniu.png') }}'>
                </div>
                <div class="flex flex-col p-5 items-center text-center justify-center w-full lg:w-1/2">
                    ...
                    <p class="text-2xl mb-12 p-5" data-scroll>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Vivamus ut
                        iaculis lectus. In
                        lobortis tortor eget venenatis ultrices. Fusce rhoncus tincidunt purus et egestas. Maecenas erat
                        nisl, porta
                        nec.</p>
        ...
        <section class="py-20">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y-0">
                <div class="flex flex-col items-center justify-center mb-4 lg:mb-0">
                    <img class="h-64 m-5" src='{{ asset('/storage/assets/img/rezervari.png') }}'>
                    ...
                    <div class="px-20 text-center">
                        <p> Maecenas erat nisl, porta
                            nec
                            fringilla in, tincidunt eget sem. Nunc in magna vitae lectus ultrices vestibulum. Maecenas
                            rutrum rhoncus
                            ipsum,
        ...
        <section class="py-20">
            <div class="flex flex-wrap md:flex-nowrap w-full p-5">
                <div class="flex flex-col p-5 items-center text-center justify-center w-full lg:w-1/2">
                    ...
                    <p class="text-2xl mb-12 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Vivamus ut
                        iaculis lectus. In
                        lobortis tortor eget venenatis ultrices. Fusce rhoncus tincidunt purus et egestas. Maecenas erat
                        nisl, porta
                ...
                <div class="flex items-center justify-center p-5 mx-auto w-full lg:w-1/2">
                    <img alt="Menu Link Image" class="object-fill"
                        src='{{ asset('/storage/assets/img/good_vibes.jpg') }}'>
                </div>
            </div>
        </section>
        <section class="my-20 bg-fixed bg-center object-contain overflow-x-visible w-full"
            style="background-image: url({{ asset('/storage/assets/img/sunset.jpg') }})">
            <div class="container px-4 mx-auto">
                <div class="pt-20 pb-24 px-8 md:px-16 rounded ">
                    <div class="flex flex-wrap -mx-8">
                        <div class="w-full lg:w-1/2 px-8 flex">
                            <div class="my-auto">
                                <h2 class="text-3xl lg:text-4xl font-semibold text-white uppercase">Pay us a visit :
                                </h2>
                                <p class="mt-2 leading-loose font-sans uppercase tracking-wide font-bold text-white">
                                    PICNIC BISTRO</p>
                                ...
                                <a class="inline-block py-4 px-8 text-xs border bg-black text-white uppercase tracking-widest font-semibold leading-none hover:bg-white hover:border-white hover:text-black rounded-none transition duration-300"
                                    href="#">Rezervati</a>
                            </div>
                        </div>
                        <div class="w-full lg:w-1/2 px-8 mt-12 lg:mt-0">
                            <div class="embed-responsive aspect-ratio-4/3">
                                <iframe allowfullscreen="" aria-hidden="false" class="embed-responsive-item"
